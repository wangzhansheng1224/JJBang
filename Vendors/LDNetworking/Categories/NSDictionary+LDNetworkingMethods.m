...
@implementation NSDictionary (LDNetworkingMethods)
...
- (NSString *)LD_urlParamsStringSignature:(BOOL)isForSignature {
  NSArray *sortedArray =
      [self LD_transformedUrlParamsArraySignature:isForSignature];
  return [sortedArray LD_paramsString];
}

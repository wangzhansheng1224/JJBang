...
@implementation LDUDIDGenerator

//+ (id)sharedInstance {
//  static dispatch_once_t pred;
//  static LDUDIDGenerator *sharedInstance = nil;
//  dispatch_once(&pred, ^{
//    sharedInstance = [[LDUDIDGenerator alloc] init];
//  });
...
//  if (udidData != nil) {
//    NSString *temp =
//        [[NSString alloc] initWithData:udidData encoding:NSUTF8StringEncoding];
...
//  [searchDictionary setObject:AIFKeychainServiceName
...
//}
//
//- (void)createPasteBoradValue:(NSString *)value
//                forIdentifier:(NSString *)identifier {
//  UIPasteboard *pb =
//      [UIPasteboard pasteboardWithName:AIFKeychainServiceName create:YES];
//  NSDictionary *dict =
//      [NSDictionary dictionaryWithObject:value forKey:identifier];
...
//      unarchiveObjectWithData:[pb dataForPasteboardType:AIFPasteboardType]];
